...
public final class FlixConstants {
	...
	public static final String FLIX_DEFAULT_VERSION = "v0.30.0"; //$NON-NLS-1$
	...
	public static final String ICON_IMAGE_KEY = "de.hetzge.eclipse.flix.image.icon.png"; //$NON-NLS-1$
